                    ...
                    entries.forEach(entry => {
                         if (entry.isIntersecting) {
                              let typed = new Typed('#title-autofill', {
                                   strings: ["Ласкаво просимо до Kochkovyi Co Group"],
                                   typeSpeed: 50,
                                   backSpeed: 30,
                                   startDelay: 1000,
                                   loop: false,
