...
(() => {
    ...
    const members = [
        ...
        },
        {
            ...
            description: 'Входить до складу Ради адвокатів міста Києва, є членом Київської торгово-промислової палати (Комітет з безпеки ведення бізнесу).Спеціалізація: надання юридичних консультацій щодо товарних марок, авторського права, конфіденційності та трудового права. Володимир займається проектами, починаючи від реєстрації та вирішення спорів у галузі інтелектуальної власності, ліцензійних угод та угод про програмне забезпечення, закінчуючи трудовими договорами та дотриманням законодавства. Володимир отримав ступінь магістра. Освіта: факультет юстиції, Національний юридичний університет імені Ярослава Мудрого(2010р.)',
        },
    ];
    ...
    const services = [
        {
            ...
            description1: 'Kochkovyi & Co Group протягом майже 10 років на ринку надання юридичних, будуючи міцні відносини та унікальні знання ринку, які можуть допомогти підприємствам безперебійно здійснювати свою діяльність у регіоні.  Великий досвід компанії у цій галузі та його прагнення допомогти своїм клієнтам досягти успіху роблять його надійним партнером і порадником для будь-якого бізнесу.',
